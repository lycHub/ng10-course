      ...
      <div class="form-row align-items-center">
        ...
        <div class="col-auto">
          <div class="input-group mb-2">
            <input #userPass="ngModel" [class.is-invalid]="userPass.touched && userPass.invalid" required minlength="6" [(ngModel)]="formValues.password" name="password" type="text" class="form-control" id="inlineFormInputGroup" placeholder="密码">
          </div>
        </div>
        <div class="col-auto">
